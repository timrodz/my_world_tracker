        ...
        >
          <table class="min-w-full divide-y divide-base-300 text-sm">
            <thead class="bg-base-200/60">
              <tr>
                <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-base-content/70">Fetched At</th>
                <th class="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-base-content/70">Price</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-base-300 bg-base-100">
              <tr :for={ticker_price <- @ticker.ticker_prices} class="hover:bg-base-200/50 transition-colors">
                <td class="px-4 py-3 text-base-content">{Calendar.strftime(ticker_price.fetched_at, "%Y-%m-%d %H:%M:%S UTC")}</td>
