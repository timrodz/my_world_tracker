defmodule WorldTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: WorldTrackerWeb.Gettext
    ...
    >
      <div class={[
        ...
        <.icon
          ...
          class="size-5 shrink-0 text-info-500 mt-0.5"
        />
        <.icon
          :if={@kind == :error}
          name="hero-exclamation-circle"
          class="size-5 shrink-0 text-danger-500 mt-0.5"
        />
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WorldTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WorldTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
